   ...
   <nav className="flex bg-black items-center justify-between flex-wrap p-6">
     ...
     <div className="block lg:hidden">
       <button
         ...
         className="flex items-center px-3 py-2 rounded text-white hover:text-green"
       >
         <svg
     ...
     >
       ...
       <div>
         ...
         <Link to='/posts' className="inline-flex items-center bg-amber-500 border-0 py-2 px-4 text-white">
           Add Blog
         </Link>
       </div>
     </div>
